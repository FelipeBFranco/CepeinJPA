CREATE TABLE endereco(id_endereco NUMERIC(5),uuid VARCHAR(128) UNIQUE ,
                      CONSTRAINT endereco_pk PRIMARY KEY(id_endereco));

CREATE TABLE pessoa(id_pessoa NUMERIC(10),uuid VARCHAR(128) UNIQUE,nome VARCHAR(70),id_endereco_fk NUMERIC(10), uuid_endereco_fk VARCHAR(128),
...
CREATE TABLE produto(id_produto NUMERIC(10),uuid VARCHAR(128) UNIQUE,descricao VARCHAR(70),
                     CONSTRAINT produto_pk PRIMARY KEY(id_produto));

CREATE TABLE curso(id_curso NUMERIC(10),uuid VARCHAR(128) UNIQUE, id_pessoa_fk NUMERIC(10),uuid_pessoa_fk VARCHAR(128), descricao VARCHAR(200),
...
CREATE TABLE pedido(id_pedido NUMERIC(10),descricao VARCHAR(70), uuid VARCHAR(128) UNIQUE,
